...
def perform(data, commission, stop_loss, take_profit):
    ...
    original_strategies = ['lr' , 'svc', 'xgboost', 'dl']  # Agregar 'dl' para deep learning
    ...
    def backtest(strat, data, initial_cash, initial_short_cash, initial_order_count, commission, stop_loss, take_profit, model_params):
        ...
        # Si 'dl' está en la estrategia, usa strategies_design_dl
        if 'dl' in strat:
            model_params['dl'] = strategies_design_dl(strat, data, df_buy, df_sell)
